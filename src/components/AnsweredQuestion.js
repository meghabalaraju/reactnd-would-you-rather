...
class AnsweredQuestion extends Component {
  render() {
    const { question, user, loggedAns } = this.props;
    ...
    const optionOnePercentage =
      optionOneVotes !== 0
        ? Math.floor((optionOneVotes / totalVotes) * 100)
        : 0;
    const optionTwoPercentage =
      optionTwoVotes !== 0
        ? Math.floor((optionTwoVotes / totalVotes) * 100)
        : 0;
      ...
      <div style={{ width: "100%", margin: "0 auto" }}>
        ...
        <div className="container-ans">
          ...
          <div className="details-ans">
            <div
              style={{ borderRight: "1px dotted black", marginRight: "50px" }}
            >
              <img
            ...
            <div className="details-ans-results">
              ...
              <div
                className={`result-ans ${
                  loggedAns === "optionOne" ? "active-ans" : ""
                }`}
              >
              ...
              <div
                className={`result-ans ${
                  loggedAns === "optionTwo" ? "active-ans" : ""
                }`}
              >
